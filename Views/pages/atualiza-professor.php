<?php
    use \Models\MainMolde;
		...
		$dados = MainMolde::select('professo2','matricula = ?',array($matricula));		
	...
	<h2><i class="fa fa-pencil"></i> Editar Dados</h2>
	 <form class="ajaxx"  action="<?php echo INCLUDE_PATH?>Models/ajax/Atualiza.php" method="post" enctype="multipart/form-data" >
	           <div class="form-group">
			          <label>Nome:</label>
					  <input type="text" name="nome" id="nome" value="<?php echo $dados['nome']; ?>" required  pattern = ".{4,}" readonly="readonly" >
				...
				<div class="form-group">
					  <label>Cpf:</label>
				      <input type="text" name="cpf" value="<?php echo $dados['cpf']; ?>" required  pattern = ".{14}" readonly="readonly">
				...
				<div class="form-group">
				      ...
				      <input type="date" name="data_de_nacimento" min="1900-01-01" max="2019-01-01" value="<?php echo $dados['data_de_nacimento']; ?>" readonly="readonly"  >
				</div><!--form-group-->
				...
				<div class="form-group">
			         <input type="submit" name="atualiza-prof" value="Atualiza!">
		        </div><!--form-group-->
     </form>
</section><!--box-content-->
</div><!-- content -- >