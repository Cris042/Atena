...
<h2><i class="fa fa-pencil"></i> Adicionar Serie</h2>
     <form  method="post" enctype="multipart/form-data">
				...
				<div class="form-group">
			         <input type="submit" name="Cadastre-serie" value="Cadastrar!">
		        </div><!--form-group-->
	</form>

	<h2 class="text-center"> Series Existentes</h2>
    <div class="listagem-csm">	         
		        	<?php  
		        	   use \Models\MainMolde;
		        	   $materiais = MainMolde::selectAll('serie','',array());
