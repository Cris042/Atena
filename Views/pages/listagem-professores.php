...
<div class="box-content">
	<h2><i class="fa fa-id-card-o" aria-hidden="true"></i> Professores Cadastrados</h2>
	<div class="busca">
		...
		<div class="box-single-wraper">
			<div class="box-single">
				...
				<div class="body-box">
					    ...
					    <div class="group-btn">
						    <a class="btn edit w100" href="<?php echo INCLUDE_PATH_MAIN ?>editar-professor?id=<?php echo $value['id']; ?>"> <i class="fa fa-pencil"></i> Editar</a>
					    </div><!--group-btn-->
				</div><!--body-box-->
			</div><!--box-single-->
