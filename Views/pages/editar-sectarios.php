<?php
	...
	{
		$id = (int)$_GET['id'];
		$Professo = MainMolde::select('secretaria2','id = ? AND diretor = 0',array($id));		
	}
	else
	{
...
<section class="box-content center">
	<h2><i class="fa fa-pencil"></i> Editar Funcionario</h2>
	 <form class="ajaxx"  action="<?php echo INCLUDE_PATH?>Models/ajax/CadastroSectario.php" method="post" enctype="multipart/form-data" >
