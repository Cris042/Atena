...
<h2><i class="fa fa-pencil"></i> Adicionar Professor</h2>
     <form class="ajax" action="<?php echo INCLUDE_PATH?>Models/ajax/CadastroProfessor.php" method="post" enctype="multipart/form-data"   autofocus>
				...
				<div class="form-group">
				      ...
				      <input type="date" name="data_de_nacimento" min="1900-01-01" max="2019-01-01" required  >
				</div><!--form-group-->
				...
				<div class="form-group">
					  <label>Senha:</label>
					  <input type="password" name="senha"  class ="required" placeholder = "minimo 8 digitos, e obrigatorio o uso se numeros e letas minusculas e minusculass" required pattern="[0-9a-zA-Z]{8,}">
				</div><!--form-group-->	
